...
8:: {
    start: ; start screen
    map := selectMap("beginner", 3, 6, "cubism") ;comment this line if you want to start directly on the map, e.g. to test your script in sandbox
    ; map := "cubism" ;uncomment this line if you want to start directly on the map, e.g. to test your script in sandbox
    sleep(config.speed)
